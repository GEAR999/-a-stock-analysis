  ...
  if (!isChatOpen) {
    return (
      <button
        ...
        className="fixed bottom-44 right-6 flex items-center gap-2 px-4 py-2 bg-[var(--accent-blue)] text-[var(--text-primary)] rounded shadow-lg hover:bg-[var(--accent-blue)] transition-colors z-50"
      >
